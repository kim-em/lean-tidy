...
attribute [search category_theory] nat_trans.naturality nat_trans.vcomp_app nat_trans.vcomp_assoc nat_trans.hcomp_app nat_trans.exchange
attribute [search category_theory] prod_id prod_comp functor.prod_obj functor.prod_map nat_trans.prod_app
attribute [search category_theory] functor.category.id_app functor.category.comp_app functor.category.nat_trans.app_naturality functor.category.nat_trans.naturality_app
...
attribute [search category_theory] nat_iso.comp_app nat_iso.naturality_1 nat_iso.naturality_2
